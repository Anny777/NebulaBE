namespace ProjectOrderFood.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        DishState = c.Int(nullable: false),
                        Dish_Id = c.Int(),
                        Custom_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                ...
                c => new
                    {
                        ...
                        WorkshopType = c.Int(nullable: false),
                        Category_Id = c.Int(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CookingDishes", "Custom_Id", "dbo.Customs");
            DropForeignKey("dbo.CookingDishes", "Dish_Id", "dbo.Dishes");
            ...
            DropIndex("dbo.CookingDishes", new[] { "Custom_Id" });
            DropIndex("dbo.CookingDishes", new[] { "Dish_Id" });
